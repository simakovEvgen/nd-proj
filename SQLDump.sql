...
--
-- Хост: localhost:8889
-- Время создания: Авг 20 2017 г., 06:03
...
CREATE TABLE `projects` (
  ...
  `src` text COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `resetpassword` (
  ...
  `expire` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Дамп данных таблицы `resetpassword`
--

INSERT INTO `resetpassword` (`login`, `hash`, `expire`) VALUES
('admin', '358c2c0f895d3d692d927b5fd41c6cfb7ebbfe90587f00c6', '1503161904496');
...
CREATE TABLE `users` (
  `login` text COLLATE utf8_bin NOT NULL,
  `passwordHash` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
('admin', 'f5eae1f3cb8aa41ea3e64ce73e2f46abc4980d87');
